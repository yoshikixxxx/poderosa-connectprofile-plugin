...
namespace Contrib.ConnectProfile {
    internal class EditEscapeSequenceColor : System.Windows.Forms.Form {
        ...
        private void AddBackColorUI(int y, ref int tabindex) {
            ...
            num.Text = ConnectProfilePlugin.Strings.GetString("Caption.EditEscapesequenceColor.BackColor");
            num.Left = 8;
            num.Width = 48;
            num.Top = y;
            num.Height = 24;
        ...
        private void AddUI(int index, int y, ref int tabindex) {
            Label num = new Label();
            num.TextAlign = ContentAlignment.MiddleCenter;
            num.Text = index == -1 ? ConnectProfilePlugin.Strings.GetString("Caption.EditEscapesequenceColor.DefaultColor") : index.ToString();
            num.Left = 8;
            num.Width = 48;
            num.Top = y;
            num.Height = 24;
