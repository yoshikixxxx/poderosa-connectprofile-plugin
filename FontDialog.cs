...
namespace Contrib.ConnectProfile
{
    ...
    internal class GFontDialog : System.Windows.Forms.Form
    {
        ...
        public GFontDialog()
        {
            ...
            this._lAsciiFont.Text = ConnectProfilePlugin.Strings.GetString("Form.GFontDialog._lAsciiFont");
            this._lCJKFont.Text = ConnectProfilePlugin.Strings.GetString("Form.GFontDialog._lCJKFont");
            this._lFontSize.Text = ConnectProfilePlugin.Strings.GetString("Form.GFontDialog._lFontSize");
            this._checkClearType.Text = ConnectProfilePlugin.Strings.GetString("Form.GFontDialog._checkClearType");
            this._checkBoldStyle.Text = ConnectProfilePlugin.Strings.GetString("Form.GFontDialog._checkBoldStyle");
            this._checkForceBoldStyle.Text = ConnectProfilePlugin.Strings.GetString("Form.GFontDialog._checkForceBoldStyle");
            ...
            this._lASCIISample.Text = ConnectProfilePlugin.Strings.GetString("Common.FontSample");
            this._lCJKSample.Text = ConnectProfilePlugin.Strings.GetString("Common.CJKFontSample");
            this.Text = ConnectProfilePlugin.Strings.GetString("Form.GFontDialog.Text");
            InitUI();
        }
        ...
        private void InitFontList()
        {
            ...
            Poderosa.Win32.EnumFontFamExProc proc = (ref Poderosa.Win32.ENUMLOGFONTEX lpelfe, ref Poderosa.Win32.NEWTEXTMETRICEX lpntme, uint fontType, IntPtr lParam) => {
            ...
            Poderosa.Win32.EnumFontFamiliesEx(hDC, ref lf, proc, IntPtr.Zero, 0);
            g.ReleaseHdc(hDC);
        ...
        private void AddFont(
            ref Poderosa.Win32.ENUMLOGFONTEX lpelfe,
            ref Poderosa.Win32.NEWTEXTMETRICEX lpntme,
            uint fontType,
            ICollection<string> asciiFonts,
            ICollection<string> cjkFonts
        )
        {
            if (fontType == Poderosa.Win32.TRUETYPE_FONTTYPE
                && (lpelfe.elfLogFont.lfPitchAndFamily & Poderosa.Win32.FIXED_PITCH) != 0 /* monospace */
        ...
        private void UpdateCJKFont(float fontSize)
        {
            ...
            _cjkFont = Poderosa.RuntimeUtil.CreateFont(fontName, fontSize);
        ...
        private void UpdateASCIIFont(float fontSize)
        {
            ...
            _asciiFont = Poderosa.RuntimeUtil.CreateFont(fontName, fontSize);
            if (_checkForceBoldStyle.Checked)
            {
                _asciiFont = new Font(_asciiFont, _asciiFont.Style | FontStyle.Bold);
            }
