    ...
    internal class GFontDialog : System.Windows.Forms.Form {
        ...
        private void InitUI() {
            ...
            foreach(FontFamily f in FontFamily.Families) {
                ...
                Poderosa.Win32.LOGFONT lf = new Poderosa.Win32.LOGFONT();
        ...
        private int FontProc(ref Poderosa.Win32.ENUMLOGFONTEX lpelfe, ref Poderosa.Win32.NEWTEXTMETRICEX lpntme, uint FontType, IntPtr lParam) {
        ...
        private void OnCJKFontChange(object sender, EventArgs args) {
            ...
            _cjkFont = Poderosa.RuntimeUtil.CreateFont(fontname, GetFontSize());
        ...
        private void OnASCIIFontChange(object sender, EventArgs args) {
            ...
            _asciiFont = Poderosa.RuntimeUtil.CreateFont(fontname, GetFontSize());
            if (_checkForceBoldStyle.Checked)
                _asciiFont = new Font(_asciiFont, _asciiFont.Style | FontStyle.Bold);
